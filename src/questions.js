...
const attQs = ["For the dots task, which box should I choose as my answer?",
"How should I report my confidence?",
"Where should I focus my attention before the dots flash on screen?"];

const att1As = ["The box containing less dots",
"The left box",
"The box containing more dots",
"The right box",
"The box that contains dots in a specific pattern"]

const att2As = ["As confident as possible",
"Report truthfully how confident I am",
"Using the extremes of the confidence scale",
"Using random points of the confidence scale",
"Less confident than I actually am"
]

const att3As = ["The top of the screen",
"The bottom of the screen",
"The part of the screen where the left box appears",
"The fixation cross at the centre of the screen",
